...
class UserVcardTable extends LivewireTableComponent
{
    ...
    /**
     * The refresh listener uses '$refresh' which preserves all component state
     * including filters (such as country filter) when refreshing after duplication.
     * This ensures duplicated business cards remain filtered by country.
     */
