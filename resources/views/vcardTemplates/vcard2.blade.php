        ...
        <div
            ...
            <div class="vcard-two__banner w-100 position-relative">
                ...
                @if (strpos($vcard->cover_url, '.mp4') !== false ||
                    ...
                    <video class="cover-video img-fluid banner-image position-relative {{ $coverClass }}" loop autoplay muted playsinline
                        alt="background video" id="cover-video">
                        <source src="{{ $vcard->cover_url }}" type="video/mp4">
                    </video>
                @else
                    <img src="{{ $vcard->cover_url }}" class="img-fluid banner-image position-relative {{ $coverClass }}"
                        ...
                        @if ($vcard->phone)
                            <div class="event-details d-flex">
                                ...
                                <span> <a href="tel:+{{ $vcard->region_code }}{{ $vcard->phone }}"
                                        class="event-name text-center pt-3 mb-0 email-btn text-decoration-none" dir="ltr">+{{ $vcard->region_code }}
                                        {{ $vcard->phone }}</a></span>
                            </div>
                        @endif
                        @if ($vcard->alternative_phone)
                            <div class="event-details d-flex">
                                ...
                                <span><a href="tel:+{{ $vcard->alternative_region_code }} {{ $vcard->alternative_phone }}"
                                        class="event-name text-center pt-3 mb-0 email-btn text-decoration-none" dir="ltr">+{{ $vcard->alternative_region_code }}
                            ...
                            <div class="modal-body">
                                ...
                                <form action="" method="post" id="newsLatterForm">
                                    ...
                                    <div class="mb-3 mt-5 d-flex gap-1 justify-content-center align-items-center email-input">
                                        <div class="w-100">
                                            <input type="email" class="email-input form-control bg-dark border-dark text-light w-100"
