        ...
        <div
            ...
            <div class="vcard__banner w-100 position-relative">
                ...
                @if (strpos($vcard->cover_url, '.mp4') !== false ||
                    ...
                    <video class="cover-video banner-image {{ $coverClass }}" loop autoplay muted playsinline alt="background video"
                        id="cover-video">
                        <source src="{{ $vcard->cover_url }}" type="video/mp4">
                    </video>
                @else
                    <img src="{{ $vcard->cover_url }}" class="img-fluid banner-image {{ $coverClass }}" alt="banner" loading="lazy" />
                @endif
                                ...
                                <div class="col-sm-6 col-12">
                                    <div
                                        ...
                                        <a href="tel:+{{ $vcard->region_code }}{{ $vcard->phone }}"
                                            class="event-name text-center mb-0 pt-2 text-decoration-none" dir="ltr">+{{ $vcard->region_code }}
                                            {{ $vcard->phone }}</a>
                                    </div>
                                </div>
                            @endif
                                ...
                                <div class="col-sm-6 col-12">
                                    <div
                                        ...
                                        <a href="tel:+{{ $vcard->alternative_region_code }} {{ $vcard->alternative_phone }}"
                                            class="event-name text-center mb-0 pt-2 text-decoration-none" dir="ltr">+{{ $vcard->alternative_region_code }}
                                ...
                                <div class="contact-form px-sm-5">
                                    ...
                                    <div class="mb-3">
                                        <input type="tel" name="phone" class="form-control" id="phone"
                                            placeholder="{{ __('messages.form.enter_phone') }}" onkeyup="if (/\D/g.test(this.value)) this.value = this.value.replace(/\D/g,&quot;&quot;)">
                                    </div>
                                    <div class="mb-3">
                                ...
                                <div class="contact-form px-sm-5" dir="rtl">
                                    ...
                                    <div class="mb-3">
                                        <input type="tel" name="phone" class="form-control text-start"
                                            id="phone" placeholder="{{ __('messages.form.enter_phone') }}" onkeyup="if (/\D/g.test(this.value)) this.value = this.value.replace(/\D/g,&quot;&quot;)">
                                    </div>
                                    <div class="mb-3">
                                ...
                                <div class="modal-content animate-bottom" id="newsLatter-content">
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <form action="" method="post" id="newsLatterForm">
                                            ...
                                            <div class="mb-3 mt-5 d-flex gap-1 justify-content-center align-items-center email-input border-none">
                                                <div class="w-100">
                                                    <input type="email"
