        ...
        <div
            ...
            <div class="vcard-eight__banner w-100 position-relative">
                ...
                @if (strpos($vcard->cover_url, '.mp4') !== false ||
                    ...
                    <video height="400px" class="cover-video img-fluid banner-image position-relative {{ $coverClass }}" loop autoplay
                        muted playsinline alt="background video" id="cover-video">
                        <source src="{{ $vcard->cover_url }}" type="video/mp4">
                    </video>
                @else
                    <img src="{{ $vcard->cover_url }}" class="img-fluid banner-image position-relative {{ $coverClass }}" alt="banner"
                        loading="lazy" />
                @endif
                <div
