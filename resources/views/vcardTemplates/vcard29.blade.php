        ...
        <div class="main-content mx-auto w-100 overflow-hidden bg-green @if (getLanguage($vcard->default_language) == 'Arabic') rtl @endif">
            ...
            <div class="banner-section position-relative">
                <div class="banner-img">
                    @php
                        $coverClass = $vcard->cover_image_type == 0 ? 'object-fit-cover w-100 h-100' : 'object-fit-contain w-100 h-100';
                    @endphp
                                ...
                                <div class="contact-box d-flex align-items-center">
                                    ...
                                    <div class="contact-desc">
                                        <a href="tel:+{{ $vcard->region_code }}{{ $vcard->phone }}"
                                            class="text-white fw-5" dir="ltr">+{{ $vcard->region_code }}{{ $vcard->phone }}</a>
                                    </div>
                                </div>
                            </div>
                        @endif
                                ...
                                <div class="contact-box d-flex align-items-center">
                                    ...
                                    <div class="contact-desc">
                                        <a href="tel:+{{ $vcard->alternative_region_code }}{{ $vcard->alternative_phone }}"
                                            class="text-white fw-5" dir="ltr">+{{ $vcard->alternative_region_code }}{{ $vcard->alternative_phone }}</a>
                                    </div>
                                </div>
                            </div>
                        @endif
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-6">
                                        <input type="tel" class="form-control"
                                            placeholder="{{ __('messages.form.phone') }}" name="phone" onkeyup="if (/\D/g.test(this.value)) this.value = this.value.replace(/\D/g,&quot;&quot;)"/>
                                    </div>
                                    <div class="col-12">
                        ...
                        <div class="modal-content animate-bottom" id="newsLatter-content">
                            ...
                            <div class="modal-body">
                                ...
                                <form action="" method="post" id="newsLatterForm">
                                    ...
                                    <div class="mb-2 mt-2 d-flex gap-1 justify-content-center align-items-center email-input">
                                        <div class="w-100">
