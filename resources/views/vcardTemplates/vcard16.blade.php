                                ...
                                <div class="row mb-sm-0 mb-4">
                                    ...
                                    @if ($vcard->phone)
                                        <div class="col-12 mb-10">
                                            ...
                                            {{ $vcard->phone }}"
                                                        class="text-primary fw-6 mb-0 fs-14" dir="ltr">+{{ $vcard->region_code }}
                                                        {{ $vcard->phone }}</a>
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="contact-box d-flex align-items-center">
                                                ...
                                                <div class="contact-desc">
                                                    ...
                                                    <a href="tel:+{{ $vcard->alternative_region_code }} {{ $vcard->alternative_phone }}"
                                                        class="text-primary fw-6 mb-0 fs-14" dir="ltr">+{{ $vcard->alternative_region_code }}
                                    ...
                                    <div class="col-sm-6">
                                        ...
                                        <div class="mb-3">
                                            <input type="tel" name="phone" class="form-control"
                                                placeholder="{{ __('messages.form.phone') }}" id="phone" onkeyup="if (/\D/g.test(this.value)) this.value = this.value.replace(/\D/g,&quot;&quot;)"/>
                                        </div>
                                    </div>
                                    <div class="col-sm-6">
                                        <div class="mb-3">
