                                        ...
                                        <div class="card-body min-250">
                                            <div class=" setting-card">
                                                <div class="logo-content mt-4">
                                                    ...
                                                    <a href="{{ rtrim($logo, '/') . '/' . (isset($logo_img) && !empty($logo_img) ? $logo_img : 'logo-dark.png') }}"
                                                        target="_blank">
                                                        <img id="blah" alt="your image"
                                                            src="{{ rtrim($logo, '/') . '/' . (isset($logo_img) && !empty($logo_img) ? $logo_img : 'logo-dark.png').'?'.time()}}"
                                        ...
                                        <div class="card-body min-250">
                                            <div class=" setting-card">
                                                <div class="logo-content mt-4">
                                                    ...
                                                    <a href="{{ rtrim($logo, '/') . '/' . (isset($logo_light_img) && !empty($logo_light_img) ? $logo_light_img : 'logo-light.png') }}"
                                                        target="_blank">
                                                        <img id="blah1" alt="your image"
                                                            src="{{ rtrim($logo, '/') . '/' . (isset($logo_light_img) && !empty($logo_light_img) ? $logo_light_img : 'logo-light.png').'?'.time()}}"
