...
<head>
    ...
    @if(Auth::user()->type == 'super admin')
        <link rel="icon" href="{{ rtrim($logo, '/') . '/favicon.png' }}" type="image/png" sizes="16x16">
    @else
        <link rel="icon" href="{{ rtrim($logo, '/') . '/' . (!empty($company_favicon) ? $company_favicon : 'favicon.png') }}" type="image/png" sizes="16x16">
    @endif
