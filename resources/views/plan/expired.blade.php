                                ...
                                <div class="card border-primary">
                                    <div class="card-body">
                                        <div class="row align-items-center">
                                            <div class="col-md-8">
                                                <h6 class="card-title mb-2">{{ $renewalPlan->name }}</h6>
                                                <p class="card-text text-muted mb-2">{{ $renewalPlan->description }}</p>
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <small class="text-muted">
                                                            <i class="ti ti-circle-plus me-1"></i>
                                                            {{ count($renewalPlan->getThemes()) }} {{ __('Themes') }}
                                                        </small>
                                                    </div>
                                                    <div class="col-md-6">
                                                        <small class="text-muted">
                                                            <i class="ti ti-building me-1"></i>
                                                            {{ $renewalPlan->business == '-1' ? 'Unlimited' : $renewalPlan->business }} {{ __('Business') }}
                                                        </small>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-4 text-end">
                                                <div class="mb-2">
                                                    <span class="h4 text-primary mb-0">
                                                        {{ env('CURRENCY_SYMBOL') ? env('CURRENCY_SYMBOL') : '$' }}{{ $renewalPlan->price }}
                                                    </span>
                                                    <small class="text-muted d-block">
                                                        {{ __('/ Duration : ') . __(ucfirst($renewalPlan->duration)) }}
                                                    </small>
                                                </div>
                                                <div class="form-check">
                                                    <input class="form-check-input" type="radio" name="renewal_plan_id" 
                                                           id="renewal_plan_{{ $renewalPlan->id }}" 
                                                           value="{{ $renewalPlan->id }}" checked>
                                                    <label class="form-check-label" for="renewal_plan_{{ $renewalPlan->id }}">
                                                        {{ __('Select This Plan') }}
                                                    </label>
                                                </div>
                                            </div>
