...
@section('content')
    <div class="container-fluid">
        ...
        <!-- Wallet Add-On Section -->
        <div class="card subscription mt-5">
            <div class="card-body">
                <div class="d-flex flex-column">
                    <div class="text-center mb-4">
                        <h3 class="text-primary">
                            <i class="fas fa-wallet me-2"></i>Premium Add-Ons
                        </h3>
                        <p class="text-muted">Enhance your vCard experience with premium features</p>
                    </div>
                    
                    <div class="row justify-content-center">
                        <!-- Wallet Integration Add-On -->
                        <div class="col-xl-4 col-lg-5 col-md-5 col-sm-6">
                            <div class="card pricing-card bg-light p-5 shadow-lg mb-8 border-warning">
                                ...
                                <h1 class="pricing-amount text-success">
                                    $1.00 USD
                                </h1>
                                    ...
                                    <div class="pricing-description text-start">
                                        <div class="mb-6">
                                            <small class="text-muted">
                                                ...
                                                Add your vCard to Apple Wallet
                                            </small>
                                        </div>
                                        <div class="mb-6">
                                            <small class="text-muted">
                                                <i class="fas fa-check-circle text-success me-1"></i>
                                                Add your vCard to Google Wallet
                                            </small>
                                        </div>
                                        <div class="mb-6">
                                            <small class="text-muted">
                                ...
                                <div class="flex-center flex-row-fluid pt-5">
                                    @if(checkFeature('wallet_integration'))
                                        <button type="button" class="btn btn-success rounded-pill mx-auto d-block" disabled>
                                            <i class="fas fa-check me-2"></i>Already Active
                                        </button>
                                    @else
                                        <a href="{{ route('choose.payment.type.wallet') }}" 
                                           class="btn btn-warning rounded-pill mx-auto">
                                            <i class="fas fa-plus me-2"></i>Add Wallet Feature
                                        </a>
                                    @endif
                                </div>
                            </div>
