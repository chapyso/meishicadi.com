                ...
                <div class="col-xxl-6 col-lg-12 col-md-4 col-6 mb-5 col-xs p-0">
                    <label class="form-label form-check p-0">
                        <input class="form-check-input feature mx-2" type="checkbox" value="1"
                            ...
                            {{ isset($feature) && $feature->wallet_integration == 1 ? 'checked' : '' }} />
                        <div>
                            <i class="fas fa-wallet me-1"></i>Wallet Integration
                            <span class="badge bg-success ms-1">Premium</span>
                            <span data-bs-toggle="tooltip" data-placement="top"
                                data-bs-original-title="Allow users to add their vCard to Apple Wallet and Google Wallet">
                                <i class="fas fa-question-circle ml-1 general-question-mark"></i>
                            </span>
                        </div>
                    </label>
