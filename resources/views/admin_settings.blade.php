                                            ...
                                            <div class="card-body pt-1 min-250">
                                                <div class=" setting-card">
                                                    <div class="logo-content mt-5">
                                                        <a href="{{ rtrim($logo, '/') . '/logo-dark.png' }}" target="_blank">
                                                            <img id="dark-logo" alt="your image"
                                                                src="{{ rtrim($logo, '/') . '/logo-dark.png?' . time() }}"
                                            ...
                                            <div class="card-body pt-1 min-250">
                                                <div class=" setting-card">
                                                    <div class="logo-content mt-5">
                                                        ...
                                                        <a href="{{ rtrim($logo, '/') . '/logo-light.png' }}" target="_blank">
                                                            <img id="light-logo" alt="your image"
                                                                src="{{ rtrim($logo, '/') . '/logo-light.png?' . time() }}"
