                        ...
                        <div class="col-xxl-3 col-lg-4 col-md-6 col-sm-5 theme-view-card">
                            <div class="theme-view-inner">
                                ...
                                <div class=" mt-3">
                                    ...
                                    <div class="d-flex align-items-center flex-wrap" id="{{ $key }}" style="gap: 5px; max-width: 100%;">
                                        @foreach ($v as $css => $val)
                                            <label class="colorinput">
                                                <input name="theme_color" id="{{ $css }}" type="radio"
                                                    ...
                                                    {{ isset($business->theme_color) && $business->theme_color == $css ? 'checked' : '' }}  {{ ($css=="color6-theme19") ? 'checked' : '' }}>
                                             ...
                                             @if( $css=="color6-theme19" ) 
                                                <script>
                                                    //   document.querySelector("#color6-theme19").click()
                                                </script>
                                            @endif
