<header class='d-flex align-items-center justify-content-between flex-grow-1 header modern-header px-3 px-xl-0'>
    ...
    <nav class="navbar navbar-expand-xl navbar-light top-navbar d-xl-flex d-block px-3 px-xl-0 py-4 py-xl-0 modern-top-navbar" id="nav-header">
    ...
    <ul class="nav align-items-center flex-nowrap modern-header-controls">
        <li class="nav-item px-3 mt-1">
            <div class="dropdown">
                <a class="btn dropdown-toggle modern-dropdown-btn" href="#" role="button" id="dropdownMenuLink"
                    data-bs-toggle="dropdown" aria-expanded="false">
                        <img src="{{ asset(\App\Models\User::FLAG[getCurrentLanguageName()]) }}" class="me-2"
                            style="width: 18px; height: 20px;" />
                {{getLanguageByKey(getCurrentLanguageName())}}
                </a>
                <ul class="dropdown-menu lang-drop-menu p-2 modern-dropdown" aria-labelledby="dropdownMenuLink">
        ...
        @if(getLogInUser()->theme_mode)
            <li class="px-xxl-3 px-2">
                <a data-turbo="false" href="{{ route('mode.theme') }}" title="{{__('messages.tooltip.light_mode')}}" class="modern-theme-toggle">
                    <i class="fa-solid fa-sun text-warning fs-2"></i>
                </a>
            </li>
        @else
            <li class="px-xxl-3 px-2">
                <a data-turbo="false" href="{{ route('mode.theme') }}" title="{{__('messages.tooltip.dark_mode')}}" class="modern-theme-toggle">
                    <i class="fa-solid fa-moon text-info fs-2"></i>
                </a>
            </li>
        @endif
