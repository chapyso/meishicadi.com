@role(App\Models\Role::ROLE_SUPER_ADMIN)
    ...
    <li class="nav-item {{ Request::is('sadmin/wallet-payments*') ? 'active' : '' }}">
        <a class="nav-link d-flex align-items-center py-3" aria-current="page" href="{{ route('wallet.payments.index') }}">
            <span class="aside-menu-icon pe-3"><i class="fas fa-wallet icon-color-bs-warning"></i></span>
            <span class="aside-menu-title">Wallet Payments</span>
        </a>
    </li>
