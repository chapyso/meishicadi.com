@role(App\Models\Role::ROLE_SUPER_ADMIN)
    ...
    <li class="nav-item position-relative mx-xl-3 mb-3 mb-xl-0">
        @if(auth()->check() && auth()->user()->hasRole('super_admin'))
            <a class="nav-link p-0 {{ Request::is('sadmin/notification-templates*') ? 'active' : '' }}" href="{{ route('notification-templates.index') }}">
                <i class="fa fa-bell me-2"></i> Notification Templates
            </a>
        @endif
    </li>
