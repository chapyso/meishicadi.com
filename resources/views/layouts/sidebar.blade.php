<div class="aside-menu-container modern-sidebar" id="sidebar">
    <div class="aside-menu-container__aside-logo flex-column-auto">
        <a data-turbo="false" href="{{ url('/') }}" class="text-decoration-none sidebar-logo" target="_blank">
            ...
            <span class="text-white fs-4 fw-bold">{{ strlen(getAppName()) > 12 ? substr(getAppName(), 0, 12) . '...' : getAppName() }}</span>
        </a>
        <button type="button" class="btn px-0 aside-menu-container__aside-menubar d-lg-block d-none sidebar-btn">
            <svg xmlns="http://www.w3.org/2000/svg" width="29" height="28" fill="#ffffff" class="bi bi-list"
                viewBox="0 0 16 16">
    ...
    <form class="d-flex position-relative aside-menu-container__aside-search search-control py-3 mt-1">
        <div class="position-relative w-100">
            <input class="form-control modern-search-input" type="text" placeholder="{{ __('auth.app.search') }}" aria-label="Search"
                id="menuSearch">
