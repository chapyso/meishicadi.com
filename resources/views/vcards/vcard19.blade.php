        ...
        <div class="main-content mx-auto w-100 overflow-hidden">
            <div class="banner-section position-relative">
                <div class="banner-img">
                    <img src="{{ isset($business->banner) && !empty($business->banner) ? str_replace('//', '/', asset('storage/card_banner/' . $business->banner)) : 'https://meishicadi.com/storage/card_banner/banner16997281171179503667.png' }}" class="w-100 h-100 object-fit-cover"
                        loading="lazy" />
                </div>
