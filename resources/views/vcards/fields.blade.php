                ...
                <div class="mt-5 row">
                    ...
                    <div class="col-md-6">
                        <div class="form-group mb-7">
                            ...
                            <span data-bs-toggle="tooltip" data-placement="top" data-bs-original-title="Enter location in plain text format for Google search and maps">
                                <i class="fas fa-question-circle ml-1 mt-1 general-question-mark"></i>
                            </span>
                            {{ Form::text('location', isset($vcard) ? $vcard->location : null, ['class' => 'form-control', 'placeholder' => 'Enter address, city, state, or any location text for Google search', 'id' => 'location-input']) }}
                            <div class="form-text text-muted">
                                <small>Enter location in plain text format (e.g., "123 Main St, New York, NY 10001" or "Central Park, New York")</small>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6">
                    ...
                    <div class="col-lg-6 mb-7">
                        ...
                        <div class="input-group">
                            {{ Form::text('dob', isset($vcard) ? $vcard->dob : null, ['class' => 'form-control date-picker', 'placeholder' => 'Click to select your date of birth', 'id' => 'dob-input', 'readonly' => 'readonly']) }}
                            <button class="btn btn-outline-secondary" type="button" id="dob-calendar-btn">
                                <i class="fas fa-calendar-alt"></i>
                            </button>
                        </div>
                        <div class="form-text text-muted">
                            <small><i class="fas fa-info-circle"></i> Click the calendar icon or the field to select your date of birth</small>
                        </div>
                    </div>
                    <div class="col-lg-6 mb-7">
