                                                                ...
                                                                <div
                                                                    ...
                                                                    <div class="choose-file">
                                                                        <input class="d-none business_logo file-validate" type="file"
                                                                            name="logo" id="file-2" accept="image/*">
                                                                            <label for="file-2" style="cursor: pointer;">
                                                                                <button type="button"
...
@push('custom-scripts')
    ...
    <script>
        $(function() {
            ...
            // Initialize file input change handlers for profile photo/logo
            $('.business_logo').on('change', function() {
                var elementid = 'business_logo';
                var url = this.value;
...
<script>
    function submitForm(e) {
        ...
        // Only validate if banner or logo don't exist
        if(banner_val==null || banner_val=='' || logo_val==null || logo_val=='')
        {
            var bannerInput = $('input[name=banner]')[0];
            var logoInput = $('input[name=logo]')[0];
            var banner = bannerInput ? bannerInput.files[0] : undefined;
            var logo = logoInput ? logoInput.files[0] : undefined;
        ...
        // If validation passes or files already exist, allow form submission
        return true;
    }
