...
<div class="row">
    ...
    <div class="col-6"><br>
        <div class="form-check form-switch custom-switch-v1">
            <input type="checkbox" class="form-check-input input-primary" name="enable_wallet_export" id="enable_wallet_export"
                {{ $plan['enable_wallet_export'] == 'on' ? 'checked=checked' : '' }}>
            <label class="custom-control-label form-control-label"
                for="enable_wallet_export">{{ __('Enable Apple & Google Wallet Export') }}</label>
        </div>
    </div>
    ...
    <div class="col-12 mt-3">
        <h6 class="text-primary">{{ __('Premium Features') }}</h6>
        <hr>
    </div>
    
    <div class="col-6"><br>
        <div class="form-check form-switch custom-switch-v1">
            <input type="checkbox" class="form-check-input input-primary" name="enable_bulk_transfer" id="enable_bulk_transfer"
                {{ $plan['enable_bulk_transfer'] == 'on' ? 'checked=checked' : '' }}>
            <label class="custom-control-label form-control-label"
                for="enable_bulk_transfer">{{ __('Enable Bulk Transfer') }}</label>
        </div>
    </div>
    
    <div class="col-6"><br>
        <div class="form-check form-switch custom-switch-v1">
            <input type="checkbox" class="form-check-input input-primary" name="enable_wallet" id="enable_wallet"
                {{ $plan['enable_wallet'] == 'on' ? 'checked=checked' : '' }}>
            <label class="custom-control-label form-control-label"
                for="enable_wallet">{{ __('Enable Wallet') }}</label>
        </div>
    </div>
    
    <div class="col-6"><br>
        <div class="form-check form-switch custom-switch-v1">
            <input type="checkbox" class="form-check-input input-primary" name="enable_integrations" id="enable_integrations"
                {{ $plan['enable_integrations'] == 'on' ? 'checked=checked' : '' }}>
            <label class="custom-control-label form-control-label"
                for="enable_integrations">{{ __('Enable Integrations') }}</label>
        </div>
    </div>
    
    <div class="col-6"><br>
        <div class="form-check form-switch custom-switch-v1">
            <input type="checkbox" class="form-check-input input-primary" name="enable_analytics" id="enable_analytics"
                {{ $plan['enable_analytics'] == 'on' ? 'checked=checked' : '' }}>
            <label class="custom-control-label form-control-label"
                for="enable_analytics">{{ __('Enable Analytics') }}</label>
        </div>
    </div>
