...
@endphp
<head>
    <title>Subscription Extension Notification</title>
                                        ...
                                        <tr>
                                            <td align="center" style="font-size:0px;padding:10px 25px;word-break:break-word;">
                                                <div style="font-family:Open Sans,helvetica;font-size:16px;line-height:22px;text-align:center;color:#555;">
                                                    <h2 style="color: #333; margin-bottom: 20px;">Subscription Extension Completed</h2>
                                                </div>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td align="left" style="font-size:0px;padding:10px 25px;word-break:break-word;">
                                                <div style="font-family:Open Sans,helvetica;font-size:14px;line-height:22px;text-align:left;color:#555;">
                                                    ...
                                                    <p>This is to confirm that a subscription extension has been successfully processed in the Meishicadi system.</p>
                                                    
                                                    <div style="background-color: #f8f9fa; padding: 20px; border-radius: 8px; margin: 20px 0;">
                                                        <h3 style="color: #007bff; margin-top: 0;">Extension Details:</h3>
                                                        <ul style="list-style: none; padding: 0;">
                                                            <li style="margin-bottom: 10px;"><strong>User Name:</strong> {{ $user->name }}</li>
                                                            <li style="margin-bottom: 10px;"><strong>User Email:</strong> {{ $user->email }}</li>
                                                            ...
                                                            <li style="margin-bottom: 10px;"><strong>Processed By:</strong> {{ $admin->name }}</li>
                                                            <li style="margin-bottom: 10px;"><strong>Processed At:</strong> {{ now()->format('Y-m-d H:i:s') }}</li>
                                                        </ul>
                                                    </div>
                                                    
                                                    <p>The user has been notified of this extension via email. Their subscription is now active until the new expiry date.</p>
                                                    
                                                    <p>If you have any questions or need to review this action, please log into the admin panel.</p>
                                                    
                                                    <p>Best regards,<br>
                                                    <strong>The Meishicadi System</strong></p>
                                                </div>
                                            </td>
                                        </tr>
                                        <tr>
