                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <form class="form-horizontal style-form" method="post" enctype="multipart/form-data">
                            ...
                            <div class="mb-3">
                                <label class="form-label">Date/Time format (frontend) <span class="badge bg-secondary">New!</span></label>
                                <div class="col-sm-10">
                            ...
                            <div class="mb-3">
                                <label class="form-label">Session expiration time <span class="badge bg-secondary">New!</span></label>
                                <div class="col-sm-10">
