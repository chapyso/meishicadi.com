...
<script src="{{ asset('custom/js/jquery.qrcode.min.js') }}" onerror="this.onerror=null; var s=document.createElement('script'); s.src='https://jeromeetienne.github.io/jquery-qrcode/src/qrcode.js'; document.head.appendChild(s);"></script>
<script> 
    ...
    $( document ).ready(function() {
        ...
        var foreground_color = `{{ isset($qr_detail->foreground_color)?$qr_detail->foreground_color:'#000000' }}`;
                ...
                // Ensure QR code library is loaded before generating
                ...
                generateQRCode();
        @else
            function generateDownloadQRCode() {
                if (typeof jQuery !== 'undefined' && typeof jQuery.fn.qrcode !== 'undefined') {
                    ...
                    setTimeout(generateDownloadQRCode, 500);
                }
            }
