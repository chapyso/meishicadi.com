...
<body class="tech-card-body">
    <div class="{{ \App\Models\Utility::themeOne()['theme4'][$business->theme_color]['theme_name'] ?? \App\Models\Utility::themeOne()['theme4']['color1-theme4']['theme_name'] ?? 'theme4-v1' }}"
        id="view_theme14">
        <main id="boxes">
                        ...
                        <section class="profile-section">
                            ...
                            <div class="profile-content">
                                ...
                                <div class="text-left desc-wrapper">
                                    <p id="{{ $stringid . '_desc' }}_preview">{{ str_replace('Government Advisory', '', $business->description ?? '') }}
                                    </p>
                                </div>
