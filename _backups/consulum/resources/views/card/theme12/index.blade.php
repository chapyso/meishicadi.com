...
<body class="tech-card-body">
    <div id="boxes">
        <div class="{{ \App\Models\Utility::themeOne()['theme12'][$business->theme_color]['theme_name'] ?? \App\Models\Utility::themeOne()['theme12']['color1-theme12']['theme_name'] ?? 'theme12-v1' }}"
            id="view_css">
            <!--wrapper start here-->
                    ...
                    <div class="share-card-wrapper">
                        ...
                        <div class="qr-scaner-wrapper">
                            ...
                            <ul class="card-social-icons">
                                <li><a href="https://twitter.com/share?url={{urlencode($url_link)}}&text="></a></li>
                                <li>
                                    @php
                                        $whatsapp_link = url('https://wa.me/?text=' . urlencode($url_link));
                                    @endphp
                                    <a href="{{ $whatsapp_link }}"></a>
                                </li>
                                <li><a href="https://www.facebook.com/sharer.php?u={{urlencode($url_link)}}"></a></li>
                                <li><a href="https://www.linkedin.com/shareArticle?url={{urlencode($url_link)}}&title="></a>
                                </li>
                            </ul>
                            <!-- </div>  -->
