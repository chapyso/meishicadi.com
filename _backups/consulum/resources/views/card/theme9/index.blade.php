...
<head>
    ...
    <link rel="icon"
        href="{{ $logo1 . (!empty($company_favicon) ? $company_favicon : 'favicon.png') }}"
...
<body class="tech-card-body">
    <div class="{{ \App\Models\Utility::themeOne()['theme9'][$business->theme_color]['theme_name'] ?? \App\Models\Utility::themeOne()['theme9']['color1-theme9']['theme_name'] ?? 'theme9-v1' }}"
        id="view_theme19">
        <main id="boxes">
                    ...
                    <div class="bussiness-card-body">
                        <section class="profile-section">
                            <div class="profile-cover">
                                <img src="{{ isset($business->banner) && !empty($business->banner) ? rtrim($banner, '/') . '/' . $business->banner : asset('custom/img/placeholder-image.jpg') }}"
                                    id="banner_preview" alt="fs"
                                    onerror="this.onerror=null; this.src='{{ asset('custom/img/placeholder-image.jpg') }}';">
                            </div>
                            <div class="profile-content">
                                <div class="user-profile">
                                    <div class="user-avatar">
                                        <img id="business_logo_preview"
                                            src="{{ isset($business->logo) && !empty($business->logo) ? preg_replace('#([^:])//+#', '$1/', rtrim($logo, '/') . '/' . ltrim($business->logo, '/')) : asset('custom/img/logo-placeholder-image-2.png') }}"
                                            alt=""
                                        ...
                                        @if (!is_null($contactinfo_content) && !is_null($contactinfo))
                                            @foreach ($contactinfo_content as $key => $val)
                                                @foreach ($val as $key1 => $val1)
                                                    ...
                                                    @elseif($key1 == "Address" && is_array($val1))
                                ...
                                <div class="text-center desc-wrapper">
                                    <p id="{{ $stringid . '_desc' }}_preview">{{ str_replace('Government Advisory', '', $business->description ?? '') }}</p>
                                </div>
                                                        ...
                                                        @if ($social_key1 != 'id')
                                                            <li class="socials_{{ $loop->parent->index + 1 }}"
                                                                ...
                                                                <a href="{{ $social_links }}" target="_blank"
                                                                    ...
                                                                    class="{{ 'social_link_' . $social_no . '_href_preview' }}"></a>
                                                            </li>
                                                        @endif
                                                        @php
                                                            $social_no++;
                                                        ...
                                                        <div class="service-card-inner">
                                                            <div class="service-icon">
                                                                <img id="{{ 's_image' . $image_count . '_preview' }}"
                                                                    src="{{ isset($content->image) && !empty($content->image) ? rtrim($s_image, '/') . '/' . $content->image : asset('custom/img/logo-placeholder-image-21.png') }}" class="img-fluid"
                                                                    alt="image">
                                                                            ...
                                                                            <div class="gallery-media">
                                                                                <a href="javascript:;" id="imagepopup"
                                                                                    ...
                                                                                    <img src="{{ isset($gallery_content->value) && !empty($gallery_content->value) ? rtrim($gallery_path, '/') . '/' . $gallery_content->value : asset('custom/img/logo-placeholder-image-2.png') }}"
                                                                                        alt="images"
                                                                                        class="imageresource"> onerror="this.onerror=null; this.src=\'{{ asset(\'custom/img/logo-placeholder-image-2.png\') }}\';"
                                                                                </a>
                                                                            </div>
                                                                        </div>
                                                                    @endif
                                                                        ...
                                                                        @elseif($gallery_content->type == 'custom_image_link')
                                                                            <a href="javascript:;" id=""
                                                                                ...
                                                                                <img class="imageresource1"
                                                                                    src="{{ isset($gallery_content->value) && !empty($gallery_content->value) ? $gallery_content->value : asset('custom/img/logo-placeholder-image-2.png') }}"
                                                                                    alt="images" id="upload_image"> onerror="this.onerror=null; this.src=\'{{ asset(\'custom/img/logo-placeholder-image-2.png\') }}\';"
                                                                            </a>
                                                                        @endif
                                                                    @endif
                                                                </div>
