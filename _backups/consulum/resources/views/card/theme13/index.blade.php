...
<body class="tech-card-body">
    ...
    <div id="boxes">
        <div id="view_css"
            class="{{ \App\Models\Utility::themeOne()['theme13'][$business->theme_color]['theme_name'] ?? \App\Models\Utility::themeOne()['theme13']['color1-theme13']['theme_name'] ?? 'theme13-v1' }}">
                                                    ...
                                                    <div class="calllink contactlink "
                                                        ...
                                                        @if ($key1 == 'Address')
                                                            ...
                                                            <img src="{{ asset('custom/theme13/icon/' . $color . '/contact/' . strtolower($key1) . '.svg') }}"
                                                                class="img-fluid">
                                                            <a href="{{ $href }}" target="_blank">@foreach ($val1 as $key2 => $val2)
                                                                    @if ($key2 == 'Address')
                                                                        <span
