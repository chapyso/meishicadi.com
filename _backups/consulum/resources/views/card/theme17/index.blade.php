...
<body class="tech-card-body">
    <div id="boxes">
        <div class="{{ \App\Models\Utility::themeOne()['theme17'][$business->theme_color]['theme_name'] ?? \App\Models\Utility::themeOne()['theme17']['color1-theme17']['theme_name'] ?? 'theme17-v1' }}"
            id="view_theme6">
            <div class="home-wrapper">
                <section class="home-banner-section">
                    <img class="home-banner" id="banner_preview"
                        src="{{ isset($business->banner) && !empty($business->banner) ? rtrim($banner, '/') . '/' . $business->banner : asset('custom/img/placeholder-image.jpg') }}"
                                                                    ...
                                                                    <div class="contact-text">
                                                                        ...
                                                                        @if ($key1 == 'Address')
                                                                            ...
                                                                            <a href="{{ $href }}"
                                                                                target="_blank">
                                                                                <span class="icon">
                                                                                    <img src="{{ asset('custom/theme17/icon/' . $color . '/contact/' . strtolower($key1) . '.svg') }}"
                                                                                        class="img-fluid">
                                                                                </span>
                                                                                @foreach ($val1 as $key2 => $val2)
                                                                                    @if ($key2 == 'Address')
