...
<body class="tech-card-body">
    <div id="boxes">
        <div class="{{ \App\Models\Utility::themeOne()['theme15'][$business->theme_color]['theme_name'] ?? \App\Models\Utility::themeOne()['theme15']['color1-theme15']['theme_name'] ?? 'theme15-v1' }}"
            id="view_theme4">
                    ...
                    @if ($j == $order_value)
                                ...
                                <div class="container">
                                    <div class="more-card-btn">
                                        <a href="{{ route('bussiness.save', $business->slug) }}" class="btn"
                                            tabindex="0">{{ __('Save Card') }}
                                        </a>
                                        <a href="javascript:;" class="btn our-card" tabindex="0">{{ __('Share Card') }}
                                        </a>
                                        <a href="javascript:;" class="btn our-contact" tabindex="0">{{ __('Contact') }}
                                        </a>
                                    </div>
                                </div>
                            </section>
                                                        ...
                                                        @if ($social_key1 != 'id')
                                                            <li class="socials_{{ $loop->parent->index + 1 }}"
                                                                ...
                                                                @else
                                                                    ...
                                                                    @endphp
                                                                @endif
                                                                <a href="{{ $social_links }}" target="_blank"></a>
                                                                </a>
                                                            </li>
                                                        @endif
                                                    @endforeach
                        ...
                        @endif
                            ...
                            @if ($order_key == 'map_iframe' )
                                    <section id="map_iframe_preview" class="card-footer print map_iframe" style=" padding: 1px 15px;@if(!$is_map_iframe_enabled)
                                                  display: none;
                                                @endif">
