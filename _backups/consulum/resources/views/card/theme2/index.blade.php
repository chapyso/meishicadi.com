...
<body class="tech-card-body ">
    <div class="{{ \App\Models\Utility::themeOne()['theme2'][$business->theme_color]['theme_name'] ?? \App\Models\Utility::themeOne()['theme2']['color1-theme2']['theme_name'] ?? 'theme2-v1' }}"
        id="view_theme12">
        <main id="boxes">
                            ...
                            @endif
                                ...
                                @if ($order_key == 'social')
                                    <section class="card-footer" id="social-div">
                                        <div class="section-title text-center">
                                            <h2 class="text-center">{{ __('Social') }}</h2>
                                        </div>
