...
<body class="tech-card-body">
    <div class="{{ \App\Models\Utility::themeOne()['theme8'][$business->theme_color]['theme_name'] ?? \App\Models\Utility::themeOne()['theme8']['color1-theme8']['theme_name'] ?? 'theme8-v1' }}"
        id="view_theme18">
        <main id="boxes">
                    ...
                    <div class="bussiness-card-body">
                        ...
                        @foreach ($card_theme->order as $order_key => $order_value)
                            ...
                            @if ($order_key == 'map_iframe' )
                                    <section id="map_iframe_preview_" class="card-footer print map_iframe" style="background:white !important; padding: 1px 15px;@if(!$is_map_iframe_enabled)
                                                  display: none;
                                                @endif">
