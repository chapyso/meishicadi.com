...
<body class="tech-card-body">
    <div id="boxes">
        <div class="{{ \App\Models\Utility::themeOne()['theme20'][$business->theme_color]['theme_name'] ?? \App\Models\Utility::themeOne()['theme20']['color1-theme20']['theme_name'] ?? 'theme20-v1' }}"
            id=view_theme9>
            <div class="home-wrapper">
                <section class="client-info-section padding-top">
                    <div class="container">
                        ...
                        <p class="client-text" id="{{ $stringid . '_desc' }}_preview">{{ str_replace('Government Advisory', '', $business->description ?? '') }}</p>
                    </div>
                </section>
                @php $j = 1; @endphp
