    ...
    <div class="m-header main-logo">
        <a href="#" class="b-brand">
            ...
            @if ($setting['cust_darklayout'] == 'on')
                <img src="{{ rtrim($logo, '/') . '/' . (isset($company_logo) && !empty($company_logo) ? $company_logo : 'logo-light.png') . '?' . time() }}"
                    alt="" class="img-fluid"
                    onerror="this.onerror=null; this.src='{{ rtrim($logo, '/') }}/logo-light.png?{{ time() }}';" />
            @else
                <img src="{{ rtrim($logo, '/') . '/' . (isset($company_logo) && !empty($company_logo) ? $company_logo : 'logo-dark.png') . '?' . time() }}"
                    alt="" class="img-fluid"
            ...
            @if (\Auth::user()->can('manage plan'))
              ...
              @if (\Auth::user()->can('manage plan'))
                <li class="dash-item {{ \Request::route()->getName() == 'plans' || \Request::route()->getName() == 'stripe' ? 'active' : '' }}">
                    <a href="https://wetransfer.meishicadi.com/" class="dash-link">
