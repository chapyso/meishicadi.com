        ...
        <div class="col-sm-12">
            <div class="row">
                    ...
                    <div class="card sticky-top" style="top:30px">
                        <div class="list-group list-group-flush" id="useradd-sidenav">
                            ...
                            <a href="#wallet-settings"
                                class="list-group-item list-group-item-action border-0">{{ __('Wallet Settings') }}
                                <div class="float-end"><i class="ti ti-chevron-right"></i></div>
                            </a>
                        </div>
                    </div>
                ...
                <div class="col-xl-9">
                    ...
                    {{-- Wallet Settings --}}
                    <div class="tab-pane" id="wallet-settings" role="tabpanel" aria-labelledby="pills-wallet-tab">
                        <div class="col-xl-12 col-lg-12 col-md-12">
                            <div class="card">
                                {{ Form::open(['route' => 'admin.wallet.settings', 'method' => 'post', 'id' => 'wallet-settings-form']) }}
                                <div class="card-header">
                                    <h5>{{ __('Wallet Integration Settings') }}</h5>
                                    <small>{{ __('Configure Apple Wallet and Google Wallet integration') }}</small>
                                </div>
                                <div class="card-body">
                                    <div class="row">
                                            ...
                                            <div class="card">
                                                <div class="card-header">
                                                    <h6 class="mb-0">
                                                        ...
                                                        {{ __('Apple Wallet Settings') }}
                                                    </h6>
                                                </div>
                                                <div class="card-body">
                                                    <div class="form-check form-switch custom-switch-v1 mb-3">
                                                        <input type="checkbox" name="apple_wallet_enabled" 
                                                               class="form-check-input input-primary" 
                                                               id="apple_wallet_enabled" 
                                                               {{ \App\Models\Utility::getValByName('apple_wallet_enabled') == 'on' ? 'checked' : '' }}>
                                                        <label class="form-check-label" for="apple_wallet_enabled">
                                                            {{ __('Enable Apple Wallet') }}
                                                        </label>
                                                    </div>
                                                    
                                                    <div class="form-group mb-3">
                                                        <label for="apple_wallet_team_identifier" class="form-label">{{ __('Team Identifier') }}</label>
                                                        <input type="text" name="apple_wallet_team_identifier" 
                                                               class="form-control" 
                                                               value="{{ \App\Models\Utility::getValByName('apple_wallet_team_identifier') }}"
                                                               placeholder="ABC123DEF4">
                                                        <small class="form-text text-muted">{{ __('Your Apple Developer Team ID') }}</small>
                                                    </div>
                                                    
                                                    <div class="form-group mb-3">
                                                        <label for="apple_wallet_pass_type_identifier" class="form-label">{{ __('Pass Type Identifier') }}</label>
                                                        <input type="text" name="apple_wallet_pass_type_identifier" 
                                                               class="form-control" 
                                                               value="{{ \App\Models\Utility::getValByName('apple_wallet_pass_type_identifier') }}"
                                                               placeholder="pass.com.yourcompany.businesscard">
                                                        <small class="form-text text-muted">{{ __('Your Pass Type Identifier from Apple Developer') }}</small>
                                                    </div>
                                                    
                                                    <div class="form-group mb-3">
                                                        <label for="apple_wallet_certificate_password" class="form-label">{{ __('Certificate Password') }}</label>
                                                        <input type="password" name="apple_wallet_certificate_password" 
                                                               class="form-control" 
                                                               value="{{ \App\Models\Utility::getValByName('apple_wallet_certificate_password') }}"
                                                               placeholder="Certificate password">
                                                    </div>
                                                    
                                                    <div class="form-group mb-3">
                                                        <label for="apple_wallet_certificate" class="form-label">{{ __('Certificate File (.p12)') }}</label>
                                                        <input type="file" name="apple_wallet_certificate" 
                                                               class="form-control" 
                                                               accept=".p12">
                                                        <small class="form-text text-muted">{{ __('Upload your Apple Wallet certificate') }}</small>
                                                    </div>
                                                    
                                                    <button type="button" class="btn btn-outline-primary btn-sm" onclick="testAppleWallet()">
                                                        <i class="fas fa-check"></i> {{ __('Test Configuration') }}
                                                    </button>
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="card">
                                                <div class="card-header">
                                                    <h6 class="mb-0">
                                                        ...
                                                        {{ __('Google Wallet Settings') }}
                                                    </h6>
                                                </div>
                                                <div class="card-body">
                                                    <div class="form-check form-switch custom-switch-v1 mb-3">
                                                        <input type="checkbox" name="google_wallet_enabled" 
                                                               class="form-check-input input-primary" 
                                                               id="google_wallet_enabled" 
                                                               {{ \App\Models\Utility::getValByName('google_wallet_enabled') == 'on' ? 'checked' : '' }}>
                                                        <label class="form-check-label" for="google_wallet_enabled">
                                                            {{ __('Enable Google Wallet') }}
                                                        </label>
                                                    </div>
                                                    
                                                    <div class="form-group mb-3">
                                                        <label for="google_wallet_service_account_email" class="form-label">{{ __('Service Account Email') }}</label>
                                                        <input type="email" name="google_wallet_service_account_email" 
                                                               class="form-control" 
                                                               value="{{ \App\Models\Utility::getValByName('google_wallet_service_account_email') }}"
                                                               placeholder="service-account@project.iam.gserviceaccount.com">
                                                    </div>
                                                    
                                                    <div class="form-group mb-3">
                                                        <label for="google_wallet_private_key" class="form-label">{{ __('Private Key') }}</label>
                                                        <textarea name="google_wallet_private_key" 
                                                                  class="form-control" 
                                                                  rows="4"
                                                                  placeholder="-----BEGIN PRIVATE KEY-----&#10;...&#10;-----END PRIVATE KEY-----">{{ \App\Models\Utility::getValByName('google_wallet_private_key') }}</textarea>
                                                    </div>
                                                    
                                                    <div class="form-group mb-3">
                                                        <label for="google_wallet_issuer_id" class="form-label">{{ __('Issuer ID') }}</label>
                                                        <input type="text" name="google_wallet_issuer_id" 
                                                               class="form-control" 
                                                               value="{{ \App\Models\Utility::getValByName('google_wallet_issuer_id') }}"
                                                               placeholder="Your Issuer ID">
                                                    </div>
                                                    
                                                    <div class="form-group mb-3">
                                                        <label for="google_wallet_class_id" class="form-label">{{ __('Class ID') }}</label>
                                                        <input type="text" name="google_wallet_class_id" 
                                                               class="form-control" 
                                                               value="{{ \App\Models\Utility::getValByName('google_wallet_class_id') }}"
                                                               placeholder="business_card">
                                                    </div>
                                                    
                                                    <button type="button" class="btn btn-outline-primary btn-sm" onclick="testGoogleWallet()">
                                                        <i class="fas fa-check"></i> {{ __('Test Configuration') }}
                                                    </button>
                                                </div>
                                            </div>
                                            ...
                                            <div class="card">
                                                ...
                                                <div class="card-body">
                                                    <div class="row">
                                                        <div class="col-md-6">
                                                            <div class="form-group mb-3">
                                                                <label for="wallet_pass_expires_after_days" class="form-label">{{ __('Pass Expires After (Days)') }}</label>
                                                                <input type="number" name="wallet_pass_expires_after_days" 
                                                                       class="form-control" 
                                                                       value="{{ \App\Models\Utility::getValByName('wallet_pass_expires_after_days') ?? 365 }}"
                                                                       min="1" max="3650">
                                                                <small class="form-text text-muted">{{ __('Number of days before wallet passes expire') }}</small>
                                                            </div>
                                                        </div>
                                                        <div class="col-md-6">
                                                            <div class="form-group mb-3">
                                                                <label for="wallet_pass_max_downloads" class="form-label">{{ __('Max Downloads per Pass') }}</label>
                                                                <input type="number" name="wallet_pass_max_downloads" 
                                                                       class="form-control" 
                                                                       value="{{ \App\Models\Utility::getValByName('wallet_pass_max_downloads') ?? 1000 }}"
                                                                       min="1" max="10000">
                                                                <small class="form-text text-muted">{{ __('Maximum number of downloads allowed per wallet pass') }}</small>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
...
@push('script-page')
<script>
function testAppleWallet() {
    $.ajax({
        url: '{{ route("admin.wallet.test-apple") }}',
        type: 'POST',
        data: {
            _token: '{{ csrf_token() }}'
        },
...
function testGoogleWallet() {
    $.ajax({
        url: '{{ route("admin.wallet.test-google") }}',
        type: 'POST',
        data: {
            _token: '{{ csrf_token() }}'
        },
