...
@php
    ...
    if(isset($ds_lang_btns) && $ds_lang_btns == "true"){
        ...
        if(!isset($dslang)) request()->merge(['lang' => 'en']);
        
        

        if(($business->title == '' || $business->sub_title == '' || $business->description == '' || $business->designation == '') && ($business->ar_title != '' || $business->ar_sub_title != '' || $business->ar_description != '' || $business->ar_designation != '')){
            request()->merge(['lang' => 'ar']);
            $have_both = false;
        }
        elseif(($business->ar_title == '' || $business->ar_sub_title == '' || $business->ar_description == '' || $business->ar_designation == '') && ($business->title != '' || $business->sub_title != '' || $business->description != '' || $business->designation != '')){
        ...
        if(isset($dslang)){
            if($dslang == "ar"){
                ...
                $business->sub_title = $business->ar_sub_title;
        ...
        <div id="view_css"
            ...
            <div class="home-wrapper">
                <section class="home-banner-section padding-top">
                    ...
                    @if(isset($ds_lang_btns) && $ds_lang_btns == "true" && isset($dslang_url) && isset($dslang_text))
                                ...
                                @foreach ($contactinfo_content as $key => $val)
                                    @foreach ($val as $key1 => $val1)
                                        ...
                                        @elseif($key1 == 'Telephone')
                                            @php $href = 'tel:'.$val1; @endphp
                                        @elseif($key1 == 'Fax')
                                            @php $href = 'fax:'.$val1; @endphp
                                        @elseif($key1 == 'Web_url')
                                            @if (!preg_match("~^(?:f|ht)tps?://~i", $val1))
                                                @php $href = "http://" . $val1; @endphp
                                            @endif
                                        @else
                                        ...
                                        @if ($key1 != 'id')
                                               @php 
                                                $svg_path = public_path('custom/theme19/icon/' . $color . '/contact/' . strtolower($key1) . '.svg');
                                                if (file_exists($svg_path)) {
                                                    ...
                                                    $svg_file_new = '<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm-2 15l-5-5 1.41-1.41L10 14.17l7.59-7.59L19 8l-9 9z" fill="currentColor"/></svg>';
                                                }
                                            @endphp
                    ...
                    @if ($j == $order_value)
                     ...
                     @endif
                                        ...
                                        @foreach ($contactinfo_content as $key => $val)
                                            @foreach ($val as $key1 => $val1)
                                                ...
                                                @elseif($key1 == 'Whatsapp')
                                                    @php $href = 'https://wa.me/'.$val1; @endphp
                                                @elseif($key1 == 'Web_url')
                                                    @if (!preg_match("~^(?:f|ht)tps?://~i", $val1))
                                                        @php $href = "http://" . $val1; @endphp
                                                    @endif
                                                ...
                                                @if ($key1 != 'id')
                                                    ...
                                                    @php 
                                                        $svg_path_2 = public_path('custom/theme19/icon/' . $color . '/contact/' . strtolower($key1) . '.svg');
                                                        if (file_exists($svg_path_2)) {
                                                            $svg_file_2 = file_get_contents($svg_path_2);
                                                            $find_string_2 = '<svg';
                                                            $position_2 = strpos($svg_file_2, $find_string_2);
                                                            $svg_file_new_2 = substr($svg_file_2, $position_2);
                                                        } else {
                                                            $svg_file_new_2 = '<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm-2 15l-5-5 1.41-1.41L10 14.17l7.59-7.59L19 8l-9 9z" fill="currentColor"/></svg>';
                                                        }
                                                    @endphp
                                                        ...
                                                        <a href="{{ $href }}" class="theme-text">
                                                            ...
                                                            <div class="contact-text">
                                                                ...
                                                                <span class="{{ $key1 . '_' . $no }}_preview"
                                                                    id="{{ $key1 . '_' . $no }}_preview" style="{{ ($key1 == "Phone" || $key1 == "Telephone") ? "direction:ltr" : ""; }}">{{ $val1 }}</span>
                        ...
                        @if ($order_key == 'custom_html')
                            <div id="{{ $stringid . '_chtml' }}_preview" class="custom_html_text " id="ds_custom_html">
