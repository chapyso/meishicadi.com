            ...
            <div class="row">
               <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-xs-12">
                  ...
                  <ul class="nav-links">
                     ...
                     <li><a href="{{ route('signup.show') }}">Get Started</a></li>
               ...
               <div class="col-lg-6 col-md-12">
                  <div class="blog-section">
                     <div class="blog-heading">
                        ...
                        <div class="btns_main">
                           <a href="{{ route('signup.show') }}" class="theme-bg try_theme_btn">
                           <span class="text-white">Get Started</span>
                           </a>
                           <a href="{{ route('login') }}" class="btn second_btn try_theme_btn">
