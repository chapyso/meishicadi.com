               ...
               <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-xs-12">
                  <div class="logo">
                     ...
                     @if ($setting['cust_darklayout'] == 'on')
                        <img src="{{ rtrim($logo, '/') . '/' . (isset($company_logo) && !empty($company_logo) ? $company_logo : 'logo-light.png').'?'.time() }}" alt=""
                              class="img-fluid"
                              onerror="this.onerror=null; this.src='{{ rtrim($logo, '/') }}/logo-light.png?{{ time() }}';" />
                     @else
                        <img src="{{ rtrim($logo, '/') . '/' . (isset($company_logo) && !empty($company_logo) ? $company_logo : 'logo-dark.png').'?'.time() }}" alt=""
                              class="img-fluid"
               ...
               <div class="row">
                  <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-xs-12">
                     <div class="logo footer_logo">
                        <h4><img src="{{ rtrim($logo, '/') . '/logo-dark.png' }}"></h4>
                     </div>
