...
<body class="tech-card-body">
    <div class="{{ \App\Models\Utility::themeOne()['theme6'][$business->theme_color]['theme_name'] ?? \App\Models\Utility::themeOne()['theme6']['color1-theme6']['theme_name'] ?? 'theme6-v1' }}"
        id="view_theme16">
        <main id="boxes">
                                                                            ...
                                                                            @elseif($gallery_content->type == 'custom_image_link')
                                                                                <a href="javascript:;" id=""
                                                                                    ...
                                                                                    <img class="imageresource1"
                                                                                        src="{{ isset($gallery_content->value) && !empty($gallery_content->value) ? $gallery_content->value : asset('custom/img/logo-placeholder-image-2.png') }}"
                                                                                        alt="images"
                                                                                        id="upload_image"> onerror="this.onerror=null; this.src=\'{{ asset(\'custom/img/logo-placeholder-image-2.png\') }}\';"
                                                                                </a>
                                                                            @endif
                                                                        @endif
                                                                    </div>
