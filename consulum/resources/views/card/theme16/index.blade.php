...
<body class="tech-card-body">
    <div id="boxes">
        <div class="{{ \App\Models\Utility::themeOne()['theme16'][$business->theme_color]['theme_name'] ?? \App\Models\Utility::themeOne()['theme16']['color1-theme16']['theme_name'] ?? 'theme16-v1' }}"
            id="view_theme5">
