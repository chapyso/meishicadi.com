...
<body class="tech-card-body">
    <div class="{{ \App\Models\Utility::themeOne()['theme10'][$business->theme_color]['theme_name'] ?? \App\Models\Utility::themeOne()['theme10']['color1-theme10']['theme_name'] ?? 'theme10-v1' }}"
        id="view_theme20">
        <main id="boxes">
