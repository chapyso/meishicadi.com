...
<body class="tech-card-body">
    <div class="{{ \App\Models\Utility::themeOne()['theme1'][$business->theme_color]['theme_name'] ?? \App\Models\Utility::themeOne()['theme1']['color1-theme1']['theme_name'] ?? 'theme1-v1' }}"
        id="view_theme11">
        <main id="boxes">
                                    ...
                                    <section class="detail-section" id="description-div">
                                        <div class="section-title">
                                            <p class="text-wrap" id="{{ $stringid . '_desc' }}_preview">
                                                {{ str_replace('Government Advisory', '', $business->description ?? '') }}</h3>
                                        </div>
                                    </section>
                                @endif
                                    ...
                                    <section class="card-footer custom_html_text">
                                        <div class="greetings-desk">
                                            <div class="user-text-avatar">
                                                <img src="{{ isset($business->logo) && !empty($business->logo) ? rtrim($logo, '/') . '/' . $business->logo : asset('custom/img/logo-placeholder-image-2.png') }}"
                                                    alt="">
