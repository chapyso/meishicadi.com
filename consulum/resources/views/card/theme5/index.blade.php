...
<body class="tech-card-body">
    <div class="{{ \App\Models\Utility::themeOne()['theme5'][$business->theme_color]['theme_name'] ?? \App\Models\Utility::themeOne()['theme5']['color1-theme5']['theme_name'] ?? 'theme5-v1' }}"
        id="view_theme15">
        <main id="boxes">
                                                        ...
                                                        @if ($social_key1 != 'id')
                                                            <li id="socials_{{ $loop->parent->index + 1 }}">
                                                                ...
                                                                <a href="{{ $social_links }}" target="_blank"
                                                                    id="{{ 'social_link_' . $social_no . '_href_preview' }}"></a>
                                                            </li>
                                                        @endif
                                                        @php
                                                            $social_no++;
                                                        ...
                                                        @if ($key1 != 'id')
                                                            <li id="contact_{{ $loop->parent->index + 1 }}">
                                                                @if ($key1 == 'Address')
                                                                    ...
                                                                    <a href="{{ $href }}">
                                                                        <span class="icon">
                                                                            <img src="{{ asset('custom/theme5/icon/' . $color . '/' . strtolower($key1) . '.svg') }}"
                                                                                class="img-fluid">
                                                                        </span>
                                                                        @foreach ($val1 as $key2 => $val2)
                                                                            @if ($key2 == 'Address')
    ...
    <script>
        ...
        var is_map_iframe_enable = "{{ $is_map_iframe_enabled }}";
        if (is_map_iframe_enable) {
            $('.map_iframe').show();
        } else {
            $('.map_iframe').hide();
        }
