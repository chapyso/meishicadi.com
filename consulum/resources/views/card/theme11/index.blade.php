...
<body class="tech-card-body">
    <div class="{{ \App\Models\Utility::themeOne()['theme11'][$business->theme_color]['theme_name'] ?? \App\Models\Utility::themeOne()['theme11']['color1-theme11']['theme_name'] ?? 'theme11-v1' }}"
        id="view_theme21">
        <main id="boxes">
                                ...
                                <div class="user-profile">
                                    ...
                                    <div class="text-center desc-wrapper">
                                        <p class="text-white" id="{{ $stringid . '_desc' }}_preview">
                                            {{ str_replace('Government Advisory', '', $business->description ?? '') }}</p>
                                    </div>
