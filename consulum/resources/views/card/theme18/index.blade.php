...
<head>
    ...
    <link rel="icon" href="{{ $logo1 . (!empty($company_favicon) ? $company_favicon : 'favicon.png') }}" type="image/png" sizes="16x16">
...
<body  class="tech-card-body">
    <div id="boxes">
        <div class="{{ \App\Models\Utility::themeOne()['theme18'][$business->theme_color]['theme_name'] ?? \App\Models\Utility::themeOne()['theme18']['color1-theme18']['theme_name'] ?? 'theme18-v1' }}" id="view_theme7">
                                                                ...
                                                                <div class="gallery-icon-pdf">
                                                                    @if(isset($gallery_content->type))
                                                                        ...
                                                                        @elseif($gallery_content->type=='image')
                                                                            ...
                                                                            alt="images" class="imageresource"> onerror="this.onerror=null; this.src=\'{{ asset(\'custom/img/logo-placeholder-image-2.png\') }}\';"  
                                                                            </a>
                                                                        @endif
                                                                    @endif
                                                                </div>
                                                                    ...
                                                                    @if(isset($gallery_content->type))
                                                                        ...
                                                                        @elseif($gallery_content->type=='custom_image_link')
                                                                            ...
                                                                            <a href="javascript:;" id="" target="" tabindex="0" class="imagepopup1">
                                                                                <img class="imageresource1" src="{{ isset($gallery_content->value) && !empty($gallery_content->value) ? $gallery_content->value : asset('custom/img/logo-placeholder-image-2.png') }}" alt="images" id="upload_image"> onerror="this.onerror=null; this.src=\'{{ asset(\'custom/img/logo-placeholder-image-2.png\') }}\';" onerror="this.onerror=null; this.src='{{ asset(''custom/img/logo-placeholder-image-2.png'') }}';"
                                                                            </a>
                                                                        @endif
                                                                    @endif
                                                                </div>
