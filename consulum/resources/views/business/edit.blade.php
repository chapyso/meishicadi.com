...
@push('css-page')
    ...
    <style>
       ...
       /* Navigation tab panel - black background with thin white border */
       .information-tab {
       ...
       /* Smooth accordion transitions for Settings sections */
       .setting-accordion .accordion-collapse {
           transition: all 0.3s ease-in-out;
       }
       
       .setting-accordion .accordion-body {
           transition: max-height 0.3s ease-in-out, opacity 0.3s ease-in-out;
       }
       
       .setting-accordion .accordion-button {
           transition: all 0.2s ease-in-out;
       }
       
       .setting-accordion .accordion-button:not(.collapsed)::after {
           transform: rotate(180deg);
           transition: transform 0.3s ease-in-out;
       }
       
       .setting-accordion .accordion-button::after {
           transition: transform 0.3s ease-in-out;
       }
       
       .information-tab .nav-item .nav-link.active {
           background-color: #333333 !important;
           color: #ffffff !important;
       }
       
       
       #inputrow_contact .input-group .input-group-text{
           padding: 5px !important;
       }
       
       #inputrow_contact .input-group .input-group-text img{
           width: 100%;
           max-width: 30px; 
           object-fit: contain;
       }
       
       /* Make Contact Info and Social icons white */
       #inputrow_contact .input-group-text img,
       #inputrow_socials .input-group-text img {
           filter: brightness(0) invert(1);
       }
       
       /* Make text white in Edit Business Details section - Personal info fields */
       .theme-detail-body h5,
       .theme-detail-body .form-label,
       .theme-detail-body label.form-label,
       .theme-detail-body .form-group .form-label,
       .theme-detail-body .form-group label,
       .theme-detail-body label[for="Title"],
       .theme-detail-body label[for="Designation"],
       .theme-detail-body label[for="Sub_Title"],
       /* Ensure all form labels in the edit form are white - MORE SPECIFIC */
       .theme-detail-body label,
       .theme-detail-body .col-lg-4 .form-group label,
       .theme-detail-body .col-lg-4 .form-group .form-label,
       .theme-detail-body .row .form-group label,
       .theme-detail-body .row .form-group .form-label {
           color: #ffffff !important;
       }
       
       /* Force white for ALL labels in personal info section */
       .theme-detail-body .col-lg-4 label,
       .theme-detail-body .row label {
           color: #ffffff !important;
       }
       
       /* Make all input and textarea text white */
       .theme-detail-body input[type="text"],
       .theme-detail-body input[type="email"],
       .theme-detail-body input[type="number"],
       .theme-detail-body input.form-control,
       .theme-detail-body textarea.form-control,
       .theme-detail-body textarea,
       .theme-detail-body .form-control,
       .theme-detail-body .emojiarea,
       .theme-detail-body .emojiarea .emojiarea-editor {
           color: #ffffff !important;
       }
       
       /* Ensure textarea content is white */
       .theme-detail-body .description-text,
       .theme-detail-body .description-text .emojiarea-editor {
           color: #ffffff !important;
       }
       
       /* Make placeholder text visible on dark backgrounds */
       .theme-detail-body input::placeholder,
       .theme-detail-body textarea::placeholder,
       .theme-detail-body .form-control::placeholder {
...
@section('breadcrumb')
    ...
    <li class="breadcrumb-item active" aria-current="page">{{ __('Business EdiTitlet') }}</li>
@endsection
@section('action-btn')
                                ...
                                <div class="row gy-4">
                                    <div class="col-lg-7 col-md-7">
                                        <div class="theme-detail-card card">
                                            ...
                                            @php
                                              $theme_ = json_decode($business->card_theme);
                                              $theme_ = isset( $theme_->theme ) ? $theme_->theme : "";
                                            @endphp
                                                    ...
                                                    <div class="col-lg-8">
                                                        ...
                                                        <div class="setting-block banner-setting">
                                                            <div class="position-relative overflow-hidden rounded">
                                                                @php
                                                                    $bannerSrc = '';
                                                                    if (isset($business->banner) && !empty($business->banner)) {
                                                                        $bannerSrc = rtrim($banner, '/') . '/' . $business->banner;
                                                                    } elseif ($theme_ == 'theme19') {
                                                                        $bannerSrc = rtrim($banner, '/') . '/banner16997281171179503667.png';
                                                                    } else {
                                                                        $bannerSrc = asset('custom/img/placeholder-image1.jpg');
                                                                    }
                                                                @endphp
                                                                <img src="{{ $bannerSrc }}" alt="images" class="w-100 imagepreview" id="banner" data-banner="{{ $business->banner ?? '' }}">
                                                                <div
                                                                    ...
                                                                    <div class="choose-file">
                                                                        ...
                                                                        <input
                                                                            ...
                                                                            <label for="file-1">
                                                                                ...
                                                                                <button type="button" 
                                                                                    onclick="selectFile('banner')" class="btn btn-primary">{{ __('Choose a
                                                                                    file...') }}</button>
                                                                                @endif
                                                                            </label>
                                                                    </div>
                                                    ...
                                                    <div class="col-lg-4">
                                                        ...
                                                        <div class="setting-block banner-small-setting">
                                                            <div class="position-relative">
                                                                <img src="{{ isset($business->logo) && !empty($business->logo) && !empty($logo) ? rtrim($logo, '/') . '/' . $business->logo : asset('custom/img/logo-placeholder-image-2.png') }}"
                                                                ...
                                                                <div
                                                                    ...
                                                                    <div class="choose-file">
                                                                        <input class="d-none business_logo" type="file"
                                                                            ...
                                                                            <label for="file-2">
                                                                                <button type="button" 
                                                                                    onclick="selectFile('business_logo')" class="btn btn-primary">{{ __('Upload') }}</button>
                                                                            </label>
                                                    ...
                                                    <div class="col-12">
                                                        {{-- <form action=""> --}}
                                                            <div class="row">
                                                                <div class="col-lg-4">
                                                                    <div class="form-group">
                                                                        {{ Form::label('Title', __('Full Name:'), ['class' => 'form-label']) }}
                                                                ...
                                                                <div class="col-lg-4">
                                                                    <div class="form-group">
                                                                        ...
                                                                        {{ Form::text('sub_title', $business->sub_title, ['class' => 'form-control validation_subtitle emojiarea', 'id' => $stringid . '_subtitle', 'placeholder' => __('Enter Company')]) }}
                                                                        @error('sub_title')
                                                                            <span class="invalid-favicon text-xs text-danger"
                                                                                role="alert">{{ $message }}</span>
                                                                        @enderror
                                                            ...
                                                            <div class="row text-right" style="text-align: right">
                                                                <div class="col-12">
                                                                    <h5 class="mb-4">{{__('للبطاقة العربية')}}</h5>
                                                                </div>
                                                            </div>
                                                            <div class="row" style="text-align: right">
                                                                <div class="col-lg-4">
                                                                    <div class="form-group">
                                                                        {{ Form::label('Sub_Title', __('شركة:'), ['class' => 'form-label']) }}
                                                                        {{ Form::text('ar_sub_title', $business->ar_sub_title, ['class' => 'form-control validation_subtitle emojiarea', 'id' => $stringid . '_ar_subtitle', 'placeholder' => __('Enter Company')]) }}
                                                                        @error('sub_title')
                                                                            <span class="invalid-favicon text-xs text-danger"
                                                                                role="alert">{{ $message }}</span>
                                                                        @enderror
                                                                ...
                                                                <div class="col-lg-4">
                                                                    <div class="form-group" style="text-align: right">
                                                                        {{ Form::label('Designation', __('تعيين:'), ['class' => 'form-label']) }}
                                                                        {{ Form::text('ar_designation', $business->ar_designation, ['class' => 'form-control', 'id' => $stringid . 'ar_designation', 'placeholder' => __('Enter Designation'), 'style' => 'text-align:right']) }}
                                                                        @error('title')
                                                                            <span class="invalid-favicon text-xs text-danger"
                                                                                role="alert">{{ $message }}</span>
                                                                        @enderror
                                                                ...
                                                                <div class="col-lg-4">
                                                                    <div class="form-group">
                                                                        {{ Form::label('Title', __('الاالاسم الكامل:'), ['class' => 'form-label']) }}
                                                                        {!! Form::text('ar_title', $business->ar_title, ['class' => 'form-control emojiarea', 'id' => $stringid . 'ar_title', 'placeholder' => __('Enter Title'),'data-name'=>'business_title']) !!}
                                                                        @error('title')
                                                                            <span class="invalid-favicon text-xs text-danger"
                                                                                role="alert">{{ $message }}</span>
                                                                        @enderror
                                                ...
                                                <div class="row" >
                                                    ...
                                                    <div class="col-12">
                                                        <div class="accordion accordion-flush setting-accordion"
                                                                        ...
                                                                        <div class="d-flex align-items-center">
                                                                            ...
                                                                            <div
                                                                                ...
                                                                                <input type="checkbox"
                                                                                    ...
                                                                                    @if( $theme_ =='theme19' ) checked="checked" @endif
                                                                            ...
                                                                            <div id="showContact">
                                                                                <div class="col-12" >
                                                                                    <div class="row gy-4" id="inputrow_contact">
                                                                                        ...
                                                                                        @php
                                                                                        if( $theme_ == "theme19" && ( is_null($contactinfo_content) || empty($contactinfo_content))  ){
                                                                                            $contactinfo_content = new stdClass();
    
                                                                                            $contactinfo_content->{1} = new stdClass();
                                                                                            $contactinfo_content->{1}->Email = "";
                                                                                            $contactinfo_content->{1}->id = 1;
                                                                                            
                                                                                            $contactinfo_content->{3} = new stdClass();
                                                                                            $contactinfo_content->{3}->Phone = "";
                                                                                            $contactinfo_content->{3}->id = 3;
                                                                                            
                                                                                            $contactinfo_content->{5} = new stdClass();
                                                                                            $contactinfo_content->{5}->Telephone = "";
                                                                                            $contactinfo_content->{5}->id = 5;
                                                                                            
                                                                                            $contactinfo_content->{7} = new stdClass();
                                                                                            $contactinfo_content->{7}->Web_url = "";
                                                                                            $contactinfo_content->{7}->id = 7;
                                                                                        }
                                                                                        ...
                                                                                        @foreach ($contactinfo_content as $key => $val)
                                                                                            @foreach ($val as $key1 => $val1)
                                                                                                @if ($key1 != 'id')
                                                                                                    @if($key1 == "Address" && is_array($val1))
                                                                                                        @php $val1 = $val1->Address; @endphp
                                                                                                    @endif
                                                                                                                ...
                                                                                                                <div
                                                                                                                    ...
                                                                                                                    <span
                                                                                                                        class="input-group-text"><img
                                                                                                                            src="{{ asset('custom/icon/white/' . $key1 . '.svg') }}"></span>
                                                                                                                    <input
                                                                                                                        type="text"
                                                                                                                        id="{{ $key1 . '_' . $no }}"
                                                                                                                        ...
                                                                                                                        value="{{ $val1 }}"
                                                                                                                        class="form-control"
                                                                                                                        placeholder="{{ $key1 == 'Web_url' ? 'Website' : $key1  }}">
                                                                                                                </div>
                                                                                                                <input
                                                                                                                    type="hidden"
                                                                                                                    name="{{ 'contact[' . $no . '][id]' }}"
                                                            ...
                                                            @if(isset($business->theme_color) && $business->theme_color != 'color6-theme19' && isset($theme_) && $theme_ != 'theme19')
                                                            ...
                                                            @endif
                                                            @if(isset($theme_) && $theme_ != 'theme19')
                                                            <div class="accordion-item">
                                                                                                            ...
                                                                                                            <div
                                                                                                                ...
                                                                                                                <input
                                                                                                                    ...
                                                                                                                    <span
                                                                                                                        ...
                                                                                                                        onclick="selectFile('s_image{{ $image_count }}')">{{__('Upload')}}
                                                                                                                    </span>
                                                                                                                <input
                                                                                                                    type="hidden"
                                                                                                ...
                                                                                                <div
                                                                                                    ...
                                                                                                    <div
                                                                                                        ...
                                                                                                        <img id="{{ 'pr_image' . $pr_image_count }}"
                                                                                                            src="{{ isset($content->image) && !empty($content->image) ? rtrim($pr_image, '/') . '/' . $content->image : asset('custom/img/logo-placeholder-image-21.png') }}"
                                                                                                            alt="images"
                                                                                                            class="imagepreview">
                                                                                                        <div
                                                                                                            class="position-absolute top-50  end-0 start-0 text-center">
                                                                                                            <div
                                                                                                                ...
                                                                                                                <input
                                                                                                                    ...
                                                                                                                    <span
                                                                                                                        class="btn btn-primary"
                                                                                                                        onclick="selectFile('pr_image{{ $pr_image_count }}')">{{__('Upload')}}
                                                                                                                    </span>
                                                                                                                <input
                                                                                                                    type="hidden"
                                                                                        ...
                                                                                        <div class="col-md-6" id="inputFormRow3">
                                                                                            <div class="services-setting-card">
                                                                                                ...
                                                                                                <div class="mb-5 services-img-setting">
                                                                                                    <div class="position-relative">
                                                                                                            <img id="{{ 't_image' . $t_image_count }}" src="{{ isset($testi_content->image) && !empty($testi_content->image) ? rtrim($image, '/') . '/' . $testi_content->image : asset('custom/img/placeholder-image12.jpg') }}" class="imagepreview" onerror="this.onerror=null; this.src='{{ asset('custom/img/placeholder-image12.jpg') }}';"/>
                                                                                                        <div
                                                                                                            class="position-absolute top-50  end-0 start-0 text-center">
                                                                                                            <div class="choose-file">
                                                                                                                <input class="d-none t_image{{ $t_image_count }}" data-multiple-caption="{count} files selected"
                                                                                                                    ...
                                                                                                                    <span
                                                                                                                        class="btn btn-primary"
                                                                                                                        onclick="selectFile('t_image{{ $t_image_count }}')">{{__('Upload')}}
                                                                                                                    </span>
                                                                                                            </div>
                                                                                                        </div>
                                                                                                    </div>
                                                                            ...
                                                                            <div id="showSocials">
                                                                                ...
                                                                                <div class="col-12" >
                                                                                    <div class="row gy-4" id="inputrow_socials">
                                                                                         ...
                                                                                         @php
                                                                                        if( $theme_ == "theme19" && ( is_null($social_content) || empty($social_content))  ){
                                                                                            $social_content = new stdClass();
    
                                                                                            $social_content->{1} = new stdClass();
                                                                                            $social_content->{1}->LinkedIn = "";
                                                                                            $social_content->{1}->id = 1;
                                                                                            
                                                                                            $social_content->{3} = new stdClass();
                                                                                            $social_content->{3}->Web_url = "";
                                                                                            $social_content->{3}->id = 3;
                                                                                            
                                                                                            $social_content->{5} = new stdClass();
                                                                                            $social_content->{5}->Whatsapp = "";
                                                                                            $social_content->{5}->id = 5;
                                                                                                        ...
                                                                                                        <div class="input-edits" >
                                                                                                            <div class="input-group">
                                                                                                                <span class="input-group-text"><img
                                                                                                                        src="{{ asset('custom/icon/white/' . $social_key1 . '.svg') }}"></span>
                                                                                                                <input type="text"
                                                            ...
                                                            <div class="accordion-item aliyan">
                                                            ...
                                                            @if(isset($theme_) && $theme_ != 'theme19')
                                                            <div class="accordion-item aliyan">
                                                                <h2 class="accordion-header" id="map_iframe">
                                                                    <button class="accordion-button collapsed"
                                                                        type="button" data-bs-toggle="collapse"
                                                                        data-bs-target="#collapse_map_iframe"
                                                                        aria-expanded="false"
                                                                        aria-controls="collapse_map_iframe">
                                                                        <span class="d-flex align-items-center">{{__('Google Maps')}}</span>
                                                                        <div class="d-flex align-items-center">
                                                                            <span class="me-2">{{__('On/Off:')}}</span>
                                                                            <div
                                                                                class="form-check form-switch custom-switch-v1">
                                                                                <input type="hidden" name="is_map_iframe_enabled" value="off"/>
                                                                                <input type="checkbox" name="is_map_iframe_enabled" id="is_map_iframe_enabled"
                                                                                    class="form-check-input input-primary"
                                                                                    {{ isset($customhtml['is_map_iframe_enabled']) && $customhtml['is_map_iframe_enabled'] == '1' ? 'checked="checked"' : '' }}/>
                                                                                <label class="form-check-label"
                                                                                    for="is_map_iframe_enabled"></label>
                                                                            </div>
                                                                        </div>
                                                                    </button>
                                                                </h2>
                                                                <div id="collapse_map_iframe"
                                                                    class="accordion-collapse collapse"
                                                                    aria-labelledby="map_iframe"
                                                                    data-bs-parent="#accordionExample">
                                                                    <div class="accordion-body">
                                                                        <div class="form-group map_iframe"> 
                                                                            <label class="d-block mb-2"
                                                                                for="">{{__('Add Business Location:')}}</label>
                                                                            <input class="form-control" name="map_iframe" id="map-iframe" cols="30" rows="3" value="{{ isset($customhtml['map_iframe']) && $customhtml['map_iframe'] ? $customhtml['map_iframe'] : '' }}">
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            ...
                                                            <!--map starts here-->
                                                            <!--<div class="accordion-item">-->
                                                            <!--    <h2 class="accordion-header" id="headingseventwo">-->
                                                            <!--        <button class="accordion-button collapsed"-->
                                                            <!--            type="button" data-bs-toggle="collapse"-->
                                                            <!--            data-bs-target="#collapseseventwo"-->
                                                            <!--            aria-expanded="false"-->
                                                            <!--            aria-controls="collapseseventwo">-->
                                                            <!--            <span class="d-flex align-items-center">{{__('Add Map')}}</span>-->
                                                            <!--            <div class="d-flex align-items-center">-->
                                                            <!--                <span class="me-2">{{__('On/Off:')}}</span>-->
                                                            <!--                <div-->
                                                            <!--                    class="form-check form-switch custom-switch-v1">-->
                                                            ...
                                                            <!--        </button>-->
                                                            <!--    </h2>-->
                                                            <!--    <div id="collapseseventwo"-->
                                                            <!--        class="accordion-collapse collapse"-->
                                                            <!--        aria-labelledby="headingseventwo"-->
                                                            <!--        data-bs-parent="#accordionExample">-->
                                                            <!--        <div class="accordion-body">-->
                                                            <!--            <div class="form-group custom_html_text">-->
                                                            <!--                <label class="d-block" for="">{{__('HTML Code:')}}</label>-->
                                                                        ...
                                                                        <div class="showGallery">
                                                                            ...
                                                                            <div class="upload-file-div video d-none">
                                                                                ...
                                                                                <div class="choose-file">
                                                                                    ...
                                                                                    <label for="file-6">
                                                                                        <button type="button" onclick="selectFile('upload_video')" class="btn btn-primary">
                                                                            ...
                                                                            <div class="upload-file-div image d-none">
                                                                                ...
                                                                                <div class="choose-file">
                                                                                    ...
                                                                                    <label for="file-7">
                                                                                        <button type="button" onclick="selectFile('upload_image1')" class="btn btn-primary">
                                                                                            {{__('Choose a file...')}}</button>
                                                                                        </label>
                                    ...
                                    <div class="col-12">
                                        <div class="theme-detail-card">
                                            ...
                                            <ul class="list-unstyled list-group sortable">
                                                ...
                                                @for ($i = 1; $i <= count( (array) $card_theme->order )+1; $i++)
                                                                    ...
                                                                    <div
                                                                        ...
                                                                        <div class="choose-file">
                                                                            <label for="meta_image">
                                                                                <div class="btn btn-md bg-primary company_logo_update" style="color: white;"> {{ __('Select image') }}
                                                                                    </div>
...
@push('custom-scripts')
    ...
    <script src="{{ asset('custom/theme1/js/slick.min.js') }}" defer="defer"></script>
        ...
        <script src="{{ asset('custom/js/jquery.qrcode.min.js') }}" onerror="loadQRCodeFallback()"></script>
        <script>
            function loadQRCodeFallback() {
                if (typeof jQuery.fn.qrcode === 'undefined') {
                    var script = document.createElement('script');
                    script.src = 'https://jeromeetienne.github.io/jquery-qrcode/src/qrcode.js';
    ...
    $("#is_gallery_enabled").change(function() {
     ...
     $("#is_map_iframe_enabled").change(function() {
        var $input = $(this);
        var enable = $input.is(":checked");

        if (enable == true) {

            $('#map_iframe_preview').show(); 
        }
        if (enable == false) {
            $('#map_iframe_preview').hide(); 
        }
    }).change();
    ...
    $("textarea").keyup(function() {
        ...
        if(dsname == 'custom_html_text'){
            var preview = $(`#${id}`).val();
            $(`#${id}_preview`).html(preview);
    ...
    const companyMapIfram = @json($specificCompanyAndTheme['map_iframe']);
    const companyTheme = '{{ $specificCompanyAndTheme['theme'] ?? '' }}';
    if (companyMapIfram == true && companyTheme === 'theme19') {
    $('#view_css .more-card-second-section .more-card-btn .btn').css('background', '#c4142c');
    $('#view_css .client-contact .contactlink a .contact-text span').css('font-size', '15px');
    $('#view_css .read-more-btn').css('background', '#c4142c');
    $('#view_css .read-more-btn').css('color', 'white');
    $('#view_css .read-more-btn svg path').css('fill', 'white');
    }
...
<script type="text/javascript">
    ...
    function generate_qr() {
        ...
        var card_url = '{{ url("/") }}/{{ $business->slug }}';
        $('.code').empty().qrcode({
            render: 'image',
            size: 500,
            ecLevel: 'H',
...
<script>
    ...
    window.initMapAutocomplete = function() {
        ...
        if (!input) {
            console.log('Map input field not found');
            return;
        }
        ...
        try {
            ...
            autocomplete.addListener('place_changed', function() {
                ...
                // Place is selected, the formatted address is automatically filled in the input
                console.log("Selected Place:", place.name);
                console.log("Address:", place.formatted_address);
                
                // Optionally set the formatted address if it's different
    ...
    // Function to check and initialize when Google Maps is ready
    var autocompleteInterval = null;
    function tryInitMapAutocomplete() {
        if (typeof google !== 'undefined' && typeof google.maps !== 'undefined' && typeof google.maps.places !== 'undefined') {
            const input = document.getElementById('map-iframe');
            if (input && input.dataset.autocompleteInitialized !== 'true') {
                window.initMapAutocomplete();
                
                // Stop interval if successfully initialized
                if (input.dataset.autocompleteInitialized === 'true' && autocompleteInterval) {
    ...
    $(document).ready(function() {
        ...
        // Also try when accordion is shown
        $('#collapse_map_iframe').on('shown.bs.collapse', function() {
            setTimeout(tryInitMapAutocomplete, 100);
        });
        
        // Set up periodic check for API loading (as backup)
        var checkCount = 0;
        autocompleteInterval = setInterval(function() {
            checkCount++;
            tryInitMapAutocomplete();
            
            // Stop after 10 seconds (100 checks) or if initialized
            if (checkCount > 100) {
                clearInterval(autocompleteInterval);
                autocompleteInterval = null;
            }
        ...
        // Accordion behavior for Settings sections (Contact Info, Social, Custom HTML)
        // Ensure only one section is open at a time with smooth transitions
        (function() {
            const targetSections = ['collapseOne', 'collapseSix', 'collapseseven'];
            
            // Function to close all target sections except the specified one
            function closeOtherSections(excludeId) {
                targetSections.forEach(function(sectionId) {
                    if (sectionId !== excludeId) {
                        const section = document.getElementById(sectionId);
                        if (section) {
                            const bsCollapse = bootstrap.Collapse.getInstance(section);
                            if (bsCollapse && section.classList.contains('show')) {
                                bsCollapse.hide();
                            } else if (section.classList.contains('show')) {
                                // Manually close if Bootstrap instance doesn't exist
            ...
            // Listen for when a section is about to show
            targetSections.forEach(function(sectionId) {
                const section = document.getElementById(sectionId);
                if (section) {
                    ...
                    // Also handle click events on buttons for immediate feedback
                    const button = document.querySelector('[data-bs-target="#' + sectionId + '"]');
                    if (button) {
                        button.addEventListener('click', function(e) {
                            // Close others when clicking this button
                            setTimeout(function() {
                                closeOtherSections(sectionId);
                            }, 10);
                        });
  ...
  <script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyDCDOKf62W_m9qEvNI-Ke9ZvhOGz7zupJQ&libraries=places&callback=initMapAutocomplete" async defer></script>
