  ...
  <head>
    ...
    @else
      <link rel="icon" href="{{(!empty($company_favicon)?asset(Storage::url('uploads/logo/' . $company_favicon)):asset('storage/uploads/logo/favicon.png'))}}" type="image/png" sizes="16x16">
   @endif
